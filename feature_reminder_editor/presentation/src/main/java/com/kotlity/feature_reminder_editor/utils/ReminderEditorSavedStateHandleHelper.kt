...
internal fun SavedStateHandle.getCurrentState(key: String = REMINDER_EDITOR_STATE_KEY) = get<ReminderEditorState>(key = key) ?: ReminderEditorState()

internal inline fun SavedStateHandle.updateState(
