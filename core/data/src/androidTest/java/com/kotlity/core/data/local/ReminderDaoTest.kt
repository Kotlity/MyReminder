...
import com.kotlity.core.data.CustomKoinTestRule
import com.kotlity.core.data.MainDispatcherRule
import com.kotlity.core.data.di.testDispatcherHandlerModule
import com.kotlity.core.data.local.di.testReminderDaoModule
import com.kotlity.core.data.local.di.testReminderDatabaseModule
...
class ReminderDaoTest: KoinTest {
    ...
    @get:Rule(order = 0)
    val koinTestRule = CustomKoinTestRule(
        listOf(
